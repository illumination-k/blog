...
export const DefaultApiFp = function(configuration?: Configuration) {
  ...
  return {
    ...
    async postCountGet(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.postCountGet(
        lang,
        category,
        tag,
        order,
...
export const DefaultApiFactory = function(configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    postCountGet(
      ...
      return localVarFp.postCountGet(lang, category, tag, order, orderBy, options).then((request) =>
    ...
    postsGet(
      ...
      return localVarFp.postsGet(lang, category, tag, order, orderBy, options).then((request) =>
        request(axios, basePath)
      );
    },
    /**
...
export class DefaultApi extends BaseAPI {
  ...
  public categoriesGet(options?: any) {
    return DefaultApiFp(this.configuration).categoriesGet(options).then((request) =>
  ...
  public openapiYmlGet(options?: any) {
    return DefaultApiFp(this.configuration).openapiYmlGet(options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
  ...
  public postCountGet(
    ...
    return DefaultApiFp(this.configuration).postCountGet(lang, category, tag, order, orderBy, options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
  ...
  public postSlugGet(slug: string, lang?: "ja" | "en", options?: any) {
    return DefaultApiFp(this.configuration).postSlugGet(slug, lang, options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
  ...
  public postUuidUuidGet(uuid: string, options?: any) {
    return DefaultApiFp(this.configuration).postUuidUuidGet(uuid, options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
  ...
  public postsGet(
    ...
    return DefaultApiFp(this.configuration).postsGet(lang, category, tag, order, orderBy, options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
  ...
  public searchGet(query?: string, limit?: number, options?: any) {
    return DefaultApiFp(this.configuration).searchGet(query, limit, options).then((request) =>
      request(this.axios, this.basePath)
    );
  }
